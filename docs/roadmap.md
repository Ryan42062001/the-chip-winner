...
- 92 automated tests covering league normalization, recommendations, identity reconciliation, encrypted sync, snapshot differencing, lineup locks, roster-aware waiver simulation, season planning, recommendation contracts, privacy-safe model context, model-output evaluation, and future projection inputs.
