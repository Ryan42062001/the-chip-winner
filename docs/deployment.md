...
The release gate covers 192 automated tests, 21 model-safety fixtures, secret scanning, companion least-privilege rules, static assets, the actual browser JavaScript dependency graph, desktop/mobile browser journeys, and automated WCAG 2.2 A/AA checks.
