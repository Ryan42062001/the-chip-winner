...
The release gate covers 185 automated tests, 21 model-safety fixtures, secret scanning, companion least-privilege rules, static assets, desktop/mobile browser journeys, and automated WCAG 2.2 A/AA checks.
