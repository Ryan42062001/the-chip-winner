...
export function renderTradeAnalysisResult(result, snapshot, escapeHtml) {
  ...
  if (result.analysisState === "INVALID_PROPOSAL") return `<section class="trade-results" aria-labelledby="trade-results-title"><div class="section-divider"><span id="trade-results-title">ANALYSIS RESULTS</span></div>${parties}<article class="panel"><div class="panel-head"><div><p class="eyebrow">INVALID PROPOSAL</p><h3>Trade cannot be analyzed yet</h3></div></div><ul>${reasons}</ul></article></section>`;
  ...
  if (result.analysisState === "ROSTER_ACTION_REQUIRED") return `<section class="trade-results" aria-labelledby="trade-results-title"><div class="section-divider"><span id="trade-results-title">ANALYSIS RESULTS</span></div>${parties}${rosterCard}<article class="panel"><h3>Another explicit roster action is required</h3><ul>${reasons}</ul><p class="data-note">The analyzer does not silently choose a drop, add a free agent, or present the expanded roster as a legal final lineup.</p></article></section>`;
  ...
  return `<section class="trade-results" aria-labelledby="trade-results-title"><div class="section-divider"><span id="trade-results-title">ANALYSIS RESULTS</span></div>${parties}
