...
function renderSeasonPlan() {
  ...
  const scenarios = buildScenarioPlan(state.snapshot, state.selectedTeamId, { weeks: futureWeeks, projectionSet: futureProjectionSet, identityMap: projectionIdentityMap });
